...
import { Bell, Shield, Palette, Clock, Send, CheckCircle, XCircle, AlertCircle, Sun, Moon, User as UserIcon, KeyRound, Check, Loader2 } from 'lucide-react'
...
export default function Settings() {
  ...
  const handleSaveProfile = async (e) => {
    ...
    setProfileMsg(null)
    try {
      const res = await API.put('/settings/profile', { name: name.trim() })
      setStoredAuth({ ...user, name: res.data.user.name }, null)
      await refreshUser()
