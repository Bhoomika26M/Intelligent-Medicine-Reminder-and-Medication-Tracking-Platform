                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((n, i) => (
                      <div key={n.id || i} className={`flex items-start gap-3 p-3 rounded-2xl ${
                        theme === 'light' ? 'hover:bg-navy-50' : 'hover:bg-white/[0.04]'
                      } transition-colors ${!n.is_read ? (theme === 'light' ? 'bg-emerald-50/50' : 'bg-emerald-500/[0.06]') : ''}`}>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {n.time && <p className={`text-xs ${theme === 'light' ? 'text-navy-400' : 'text-white/30'} mt-0.5`}>{n.time}</p>}
                        </div>
                        {!n.is_read && (
